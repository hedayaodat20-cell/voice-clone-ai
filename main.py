...
def get_client():
    ...
    if client is None:
        ...
        print("Connected to Hugging Face XTTS Space.", flush=True)
...
async def generate(
    ...
    try:
        ...
        if not os.path.exists(audio_path):
            ...
            raise RuntimeError(
                f"XTTS returned a path that does not exist: {audio_path}"
            )
